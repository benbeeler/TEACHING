...
[Kernels]
  ...
  [heat_source]
    type = HeatSource
    variable = temperature
    block = 2                     # Only apply heat source to the fuel block
    function = source             # Calls source function
  []
[]
...
[BCs]
  ...
  [top_bottom]
    type = NeumannBC              # Simple u=value BC
    variable = temperature        # Variable to be set
    boundary = 'top bottom'       # Name of a sideset in the mesh
    value = 0
  []
[]
...
[Executioner]
  ...
  nl_rel_tol = 5e-6
  nl_abs_tol = 1e-7               # default was very small, this allows more reasonable space
  nl_max_its = 20
  l_tol = 1e-4
  l_max_its = 50
  time = 100                      # (s)
