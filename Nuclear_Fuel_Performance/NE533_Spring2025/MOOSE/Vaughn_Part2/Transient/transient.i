...
[Functions]
    [./q_func]
        type = ParsedFunction
        expression = '((350*exp(-(t-20)^2/2)+350)*cos(1.2*(y/50-1)))/(0.25*pi)'
    [../]
    [./fuel_k_func]
        type = ParsedFunction
    ...
    [./T_cool_func]
      ...
      #specific heat of 4180 J/kgK, and mdot of 0.085 kg/s
    [../]
    [./gap_k_func]
        type = ParsedFunction
...
[ICs]
  [./initial_temperature]
    ...
    value = 500   # ✅ Set a safe starting temperature
  [../]
[]
...
[Executioner]
  ...
  [./TimeIntegrator]
    ...
    # type = Ralston
  [../]
  num_steps = 1000 # Run for 1000 time steps, solving the system each step.
...
#
  ...
  [./radial_slice]
    type = LineValueSampler
    variable = T
    start_point = '0.0 52.1 0.0'    # start at centerline
    end_point   = '0.605 52.1 0.0'  # end at outer cladding
    num_points = 1000
    sort_by = x
    execute_on = 'timestep_end'
  [../]
