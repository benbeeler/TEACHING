...
[Materials]
  ...
  [gap_material]
    type = ADHeatConductionMaterial
    thermal_conductivity = 2.334e-3 # [W/cm·K] value for He-filled gap (For pure He, kgap=16x10^-6 * T^0.79 (W/cm-K))
	block = 2
  []

  [cladding_material]
    type = ADHeatConductionMaterial
    thermal_conductivity = 0.17  # [Wc/m·K] (value from table in lecture 3, slide 31)
	block = 3
  []
[]
